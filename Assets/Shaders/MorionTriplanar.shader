...
Shader "MorionTriplanar"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_MidTexture0("Mid Texture 0", 2D) = "white" {}
		_TopTexture0("Top Texture 0", 2D) = "white" {}
		_BotTexture0("Bot Texture 0", 2D) = "white" {}
		_distancia("distancia", Float) = 0
		_Piso("Piso", 2D) = "white" {}
		_AlturaPiso("AlturaPiso", Float) = 0.5
		[ASEEnd]_alfa("alfa", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				if( IN.ase_texcoord3.xyz.y <= _AlturaPiso )
				ifLocalVar35 = 1.0;
				else
				ifLocalVar35 = 0.0;
				float2 uv_Piso = IN.ase_texcoord4.xy * _Piso_ST.xy + _Piso_ST.zw;
				float2 temp_cast_0 = (_distancia).xx;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float4 triplanar10 = TriplanarSampling10( _TopTexture0, _MidTexture0, _BotTexture0, WorldPosition, ase_worldNormal, _alfa, temp_cast_0, float3( 1,1,1 ), float3(0,0,0) );
				float4 temp_output_33_0 = ( ifLocalVar35 == 1.0 ? tex2D( _Piso, uv_Piso ) : triplanar10 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = temp_output_33_0.rgb;
				float Alpha = temp_output_33_0.a;
				float AlphaClipThreshold = temp_output_33_0.a;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float ifLocalVar35 = 0;
				if( IN.ase_texcoord2.xyz.y <= _AlturaPiso )
				ifLocalVar35 = 1.0;
				else
				ifLocalVar35 = 0.0;
				float2 uv_Piso = IN.ase_texcoord3.xy * _Piso_ST.xy + _Piso_ST.zw;
				float2 temp_cast_0 = (_distancia).xx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float ifLocalVar35 = 0;
				if( IN.ase_texcoord.xyz.y <= _AlturaPiso )
				ifLocalVar35 = 1.0;
				else
				ifLocalVar35 = 0.0;
				float2 uv_Piso = IN.ase_texcoord1.xy * _Piso_ST.xy + _Piso_ST.zw;
				float2 temp_cast_0 = (_distancia).xx;
				float3 ase_worldPos = IN.ase_texcoord2.xyz;
				float3 ase_worldNormal = IN.ase_texcoord3.xyz;
				float4 triplanar10 = TriplanarSampling10( _TopTexture0, _MidTexture0, _BotTexture0, ase_worldPos, ase_worldNormal, _alfa, temp_cast_0, float3( 1,1,1 ), float3(0,0,0) );
				float4 temp_output_33_0 = ( ifLocalVar35 == 1.0 ? tex2D( _Piso, uv_Piso ) : triplanar10 );
				

				surfaceDescription.Alpha = temp_output_33_0.a;
				surfaceDescription.AlphaClipThreshold = temp_output_33_0.a;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float ifLocalVar35 = 0;
				if( IN.ase_texcoord1.xyz.y <= _AlturaPiso )
				ifLocalVar35 = 1.0;
				else
				ifLocalVar35 = 0.0;
				float2 uv_Piso = IN.ase_texcoord2.xy * _Piso_ST.xy + _Piso_ST.zw;
				float2 temp_cast_0 = (_distancia).xx;
				float3 ase_worldPos = IN.ase_texcoord3.xyz;
				float4 triplanar10 = TriplanarSampling10( _TopTexture0, _MidTexture0, _BotTexture0, ase_worldPos, IN.normalWS, _alfa, temp_cast_0, float3( 1,1,1 ), float3(0,0,0) );
				float4 temp_output_33_0 = ( ifLocalVar35 == 1.0 ? tex2D( _Piso, uv_Piso ) : triplanar10 );
...
Node;AmplifyShaderEditor.ConditionalIfNode;35;114.9194,-451.2375;Inherit;False;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;16;-262.0345,-713.5557;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;38;-191.9838,-436.5217;Inherit;False;Constant;_Float0;Float 0;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-180.2837,-345.5219;Inherit;False;Constant;_Float1;Float 1;5;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-275.7639,-568.8625;Inherit;False;Property;_AlturaPiso;AlturaPiso;5;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Compare;33;353.2337,-179.9627;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;34;-59.50497,-149.3427;Inherit;True;Property;_Piso;Piso;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;895.8458,-177.6204;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;MorionTriplanar;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;0;638111405636877897;  Blend;0;0;Two Sided;0;638111404390713654;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TriplanarNode;10;-150.6,40.70001;Inherit;True;Cylindrical;World;False;Top Texture 0;_TopTexture0;white;1;None;Mid Texture 0;_MidTexture0;white;0;None;Bot Texture 0;_BotTexture0;white;2;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT3;1,1,1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.BreakToComponentsNode;42;650.0555,-62.83247;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.RangedFloatNode;15;-328.5063,54.46028;Inherit;False;Property;_distancia;distancia;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;43;-377.9072,172.4205;Inherit;False;Property;_alfa;alfa;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
WireConnection;35;0;16;2
...
WireConnection;33;3;10;0
WireConnection;1;2;33;0
WireConnection;1;3;42;3
WireConnection;1;4;42;3
WireConnection;10;3;15;0
WireConnection;10;4;43;0
WireConnection;42;0;33;0
ASEEND*/
//CHKSM=80EFEEA496E13C9BD86AC184A1C5174E5F32DA94